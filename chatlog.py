...
def main(v_id,c_id):
    ...
    while True :
        if i == 0 :
            URL = 'https://api.twitch.tv/v5/videos/'+str(videoId)+'/comments?content_offset_seconds=0' 
            i += 1
        else:
            URL = 'https://api.twitch.tv/v5/videos/'+str(videoId)+'/comments?cursor=' 
            URL +=  nextCursor   
    ...
    f = open(str(videoId)+".txt", 'wt',encoding="utf-8")
...
if __name__ == "__main__":
    ...
    main(739935451,"roekysd1k7159ty34iasxptdz2yegt")
